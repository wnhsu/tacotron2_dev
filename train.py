...
def prepare_dataloaders(hparams):
    ...
    trainset = TextMelLoader(hparams.training_files, hparams,
                             hparams.training_wav_h5,
                             hparams.training_wav_path2idx)
    valset = TextMelLoader(hparams.validation_files, hparams,
                           hparams.validation_wav_h5,
                           hparams.validation_wav_path2idx)
...
def train(output_directory, log_directory, checkpoint_path, warm_start, n_gpus,
    ...
    for epoch in range(epoch_offset, hparams.epochs):
        ...
        if hparams.text_or_code == 'code' and hparams.chunk_code:
            ...
            train_loader.dataset.set_code_chunk_size(chunk_size)
            train_loader.dataset.set_chunking_mode(
                    hparams.always_chunk,
                    min(chunk_size, hparams.min_chunk))
